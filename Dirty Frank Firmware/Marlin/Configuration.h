...
#define STRING_CONFIG_H_AUTHOR "(NateSchnase, default config)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Dirty Frank"
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3]]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 77.94, 80.56, 398.51, 621.39 }
